...
export const resumeText = {
    arrays: 'Arrays, a estrutura mais básica, semelhante a uma lista, pode ser muito útil para tarefas simples',
    dictionary: 'Dicionários, primeira estrutura utilizando chave, valor, se você está procurando uma forma de armazenar seus elementos de forma parecida com os arrays, mas quer buscar um valor com base em uma chave',
